...
from .views import  AiView, CalorieLogViewSet, UserProfileView, RegisterView, ChatHistoryView, FoodSearchAPIView, MacroFromImageView
...
urlpatterns = [
    ...
    path('api/foods/', FoodSearchAPIView.as_view(), name='food-search'),
